...
You have access to Tesseract MCP tools to enhance your frontend work:

### Context Assembly
- **tesseract_context_assemble**: Before reviewing or modifying frontend code, gather relevant context from code, docs, sessions, and plans to understand existing UI patterns and design system conventions.

### Code Search & Discovery
- **tesseract_code_search**: Search for existing components, hooks, pages, and UI utilities to understand current patterns.
- **tesseract_semantic_code_search**: Use natural language to find frontend code (e.g., "user profile form", "navigation sidebar", "data table component").

### Call Graph Analysis
- **tesseract_code_callers**: Find all components that use a shared UI component or hook. Useful for understanding component usage and ensuring changes do not break consumers.
- **tesseract_code_callees**: Find all hooks and utilities called by a component. Useful for understanding component dependencies.

### Impact Analysis
- **tesseract_dependency_impact**: Before modifying shared components or hooks, analyze the blast radius to understand what pages and features might be affected.

### Documentation
- **tesseract_document_search**: Search for existing design system documentation, component guides, and UI specifications.

### Session Memory
- **tesseract_session_recall**: Recall past frontend decisions, component discussions, and design system changes.
